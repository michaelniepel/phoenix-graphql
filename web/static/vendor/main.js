...
var _michaelniepel$elm_graphql_module$GraphQL$maybeEncode = F2(
	function (e, v) {
		var _p0 = v;
		if (_p0.ctor === 'Nothing') {
...
var _michaelniepel$elm_graphql_module$GraphQL$apply = F2(
	function (func, value) {
		return A3(
			_elm_lang$core$Json_Decode$map2,
			F2(
...
var _michaelniepel$elm_graphql_module$GraphQL$queryResult = function (decoder) {
	return _elm_lang$core$Json_Decode$oneOf(
		{
			ctor: '::',
			_0: A2(
...
var _michaelniepel$elm_graphql_module$GraphQL$buildRequestWithBody = F6(
...
var _michaelniepel$elm_graphql_module$GraphQL$fetch = F6(
	function (verb, url, query, operation, variables, decoder) {
		var request = A6(_michaelniepel$elm_graphql_module$GraphQL$buildRequestWithBody, 'POST', url, query, operation, variables, decoder);
		return request;
	});
var _michaelniepel$elm_graphql_module$GraphQL$mutation = F5(
	function (url, query, operation, variables, decoder) {
		return A6(_michaelniepel$elm_graphql_module$GraphQL$fetch, 'POST', url, query, operation, variables, decoder);
	});
var _michaelniepel$elm_graphql_module$GraphQL$query = F6(
...
var _user$project$Blog$users = function () {
...
var _user$project$Main$Model = F3(
	function (a, b, c) {
		return {users: a, error: b, fetching: c};
	});
...
var _user$project$Main$fetchUsers = A2(_elm_lang$http$Http$send, _user$project$Main$FetchUsers, _user$project$Blog$users);
var _user$project$Main$update = F2(
	function (msg, model) {
		var _p0 = msg;
		if (_p0.ctor === 'LoadUsers') {
			return {
				ctor: '_Tuple2',
	...
	return A2(
		...
		{ctor: '[]'},
		{
			...
			_0: A2(
				...
				{
					ctor: '::',
					_0: _elm_lang$html$Html_Events$onClick(_user$project$Main$LoadUsers),
					_1: {ctor: '[]'}
				},
				{
					ctor: '::',
					_0: _elm_lang$html$Html$text('Load users'),
					_1: {ctor: '[]'}
				}),
			_1: {
				ctor: '::',
...
var _user$project$Main$main = _elm_lang$html$Html$program(
	{init: _user$project$Main$init, view: _user$project$Main$mainView, update: _user$project$Main$update, subscriptions: _user$project$Main$subscriptions})();
