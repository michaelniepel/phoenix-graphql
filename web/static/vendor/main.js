...
var _user$project$Main$userDetail = function (user) {
	return A2(
...
var _user$project$Main$usersSection = function (model) {
	var listHtml = _elm_lang$core$Native_Utils.eq(model.fetching, true) ? A2(
		_elm_lang$html$Html$p,
		{ctor: '[]'},
		{
			ctor: '::',
			_0: _elm_lang$html$Html$text('Fetching...'),
			_1: {ctor: '[]'}
		}) : A2(
		...
		A2(
			_elm_lang$core$List$map,
			function (user) {
				return _user$project$Main$userDetail(user);
			},
			model.users));
	return A2(
